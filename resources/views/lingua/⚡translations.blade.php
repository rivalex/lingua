...
<section class="flex flex-col gap-4">
    <div class="relative w-full">
        <flux:heading size="xl" level="1">
            <div class="flex flex-row gap-2 items-center">
                ...
                <p>@lang('rivalex::lingua.translations.header', ['locale' => $language->native])</p>
            </div>
        </flux:heading>
        <flux:subheading size="lg"
                         class="mb-4">@lang('rivalex::lingua.translations.subheader', ['locale' => $language->native])</flux:subheading>
    ...
    <div
        ...
        <div class="flex flex-col lg:flex-row w-full lg:w-max items-center gap-4">
            ...
            <flux:select wire:model.change.live="group"
                         ...
                         :searchable="Flux::pro()"
                         clearable
                         :placeholder="Flux::pro() ? __('rivalex::lingua.translations.group.placeholder') : null"
                         wire:island="translationTable">
                @if(!Flux::pro())
                    <flux:select.option
                        value="">@lang('rivalex::lingua.translations.group.all_groups')</flux:select.option>
                @endif
            ...
            @if($currentLocale !== defaultLocale())
                <flux:field variant="inline" class="flex items-center gap-2 w-fit">
                    <flux:label><p
                            style="white-space: nowrap; font-weight: 400;">@lang('rivalex::lingua.translations.table.show_only_missing')</p>
                    </flux:label>
    ...
    <div class="flex flex-col w-full gap-2">
        <x-lingua::action-message on="translation_added">
        ...
        <x-lingua::action-message on="translation_added_fail">
        ...
        <x-lingua::action-message on="translation_updated">
            <flux:badge color="green">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="check-circle" size="sm"/>
        ...
        <x-lingua::action-message on="translation_updated_fail">
            <flux:badge color="red">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="exclamation-circle" size="sm"/>
        ...
        <x-lingua::action-message on="translation_deleted">
            <flux:badge color="green">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="check-circle" size="sm"/>
        ...
        <x-lingua::action-message on="translation_deleted_fail">
            <flux:badge color="red">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="exclamation-circle" size="sm"/>
        ...
        <x-lingua::action-message on="translation_deleted_local">
            <flux:badge color="green">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="check-circle" size="sm"/>
                    <p>@lang('language.lang_updated')</p>
        ...
        <x-lingua::action-message on="translation_deleted_local_fail">
            <flux:badge color="red">
                <div class="flex items-center gap-2" style="white-space: normal;">
                    <flux:icon icon="exclamation-circle" size="sm"/>
                    <p>@lang('language.lang_updated')</p>
    ...
    <div class="relative">
        ...
        <flux:table :paginate="$this->translations()" class="w-full">
            <flux:table.columns>
                <flux:table.column
                    style="width: 20%;">@lang('rivalex::lingua.translations.table.columns.group_key')</flux:table.column>
                <flux:table.column style="width: 30%;">
                    <div class="flex flex-row gap-2 items-center">
                        <p>@lang('rivalex::lingua.translations.table.columns.default')</p>
                        <x-icon name="flag-language-{{ defaultLocale() }}" style="width: 1rem; height: 1rem;"/>
                    </div>
                </flux:table.column>
                <flux:table.column>
                    <div class="flex flex-row gap-2 items-center">
                        <p>@lang('rivalex::lingua.translations.table.columns.translation')</p>
...
{{--    <script type="module" src="{{ lt_asset('js/lingua.min.js') }}"></script>--}}
