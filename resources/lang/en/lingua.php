...
return [
    ...
    'settings' => [
        ...
        'subtitle' => 'Configure the behaviour of the Lingua language selector and UI.',
        'selector' => [
            'title' => 'Language Selector',
            'subtitle' => 'Control how the language selector is displayed to your users.',
            'show_flags' => 'Show flag icons',
            'show_flags_description' => 'Display country flag icons next to language names in the selector.',
            'mode' => 'Selector mode',
            'mode_description' => 'Choose how the language selector renders in your application.',
